        ...
        <footer className="bg-black text-white pt-16 pb-8 border-t-4 border-red-600">
            <div className="container-justice">
                ...
                <div className="text-center mb-16 pt-8 border-t border-gray-800">
                    ...
                    <div className="bg-gray-900 p-6 border border-gray-800 rounded-sm max-w-md mx-auto">
                ...
                <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
                    ...
                    <div className="flex gap-6">
                        ...
                        <Link href="/preview" className="hover:text-white transition-colors">Previews</Link>
                    </div>
                </div>
            </div>
        </footer>
