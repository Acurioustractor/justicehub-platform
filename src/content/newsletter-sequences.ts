...
- Evidence library — 1,076 verified interventions with cost data
...
— The CONTAINED Network`,
    },
    {
      ...
      preheader: 'We track $83.7B in justice funding. Here\'s what matters for your org.',
      delayDays: 2,
      body: `We've mapped $83.7 billion in justice funding across Australia — 94,742 records from federal, state, and local sources.
...
— The CONTAINED Network`,
    },
    {
      ...
      delayDays: 9,
      body: `The ALMA evidence library now has 1,076 verified interventions — but we know there's more.
...
- Evidence library — 1,076 interventions with cost data and outcomes
...
The best youth justice stories aren't about incidents. They're about the 1,076 programs quietly proving that alternatives work — for a fraction of the cost.
...
- Funding landscape — $83.7B tracked across 94,742 records
...
— The CONTAINED Network`,
    },
    {
      ...
      delayDays: 5,
      body: `Out of 1,076 interventions in the ALMA database, 4 have the highest evidence level: Proven (RCT/quasi-experimental, replicated).
