...
export const metadata: Metadata = {
  title: 'QLD Youth Justice System Map — Follow the Money | JusticeHub',
  description:
    'Bloomberg-terminal-style intelligence on Queensland youth justice: $37.8B in contracts, 200K records, 8 departments. Follow the money. Hear the voices. See the alternative.',
  openGraph: {
    title: 'QLD Youth Justice System Map',
    description:
      '$37.8B in contracts across 8 departments. Who gets the money? What do they promise? What actually works?',
  },
};

// ── Hardcoded contract aggregates (computed from state_tenders, updated periodically) ──
...
const COMMUNITY_COST_PER_DAY = 200;
const DETENTION_COMMUNITY_RATIO = Math.round(DETENTION_COST_PER_DAY / COMMUNITY_COST_PER_DAY * 10) / 10;
const KIDS_IN_DETENTION_QLD = 40;
const DETENTION_TOTAL_ANNUAL = KIDS_IN_DETENTION_QLD * DETENTION_COST_PER_YEAR;

// What $48M could buy instead
const ALTERNATIVES = [
...
export default async function QldSystemPage() {
  ...
  const getCrossover = (metric: string, state = 'QLD'): number | null => {
    const row = crossoverStats.find(s => s.metric === metric && s.state === state);
  ...
  const totalContracts = DEPARTMENTS.reduce((s, d) => s + d.contracts, 0);
  const totalContractValue = DEPARTMENTS.reduce((s, d) => s + d.totalValue, 0);
  ...
  const topInterventions = qldInterventions.slice(0, 10);
    ...
    <div className="min-h-screen" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
      ...
      <nav className="bg-[#0A0A0A] border-b border-gray-800 px-6 py-3">
        <div className="max-w-7xl mx-auto flex items-center gap-6 text-sm font-mono">
          ...
          <span className="text-[#DC2626]">QLD System Map</span>
      ...
      <header className="bg-[#0A0A0A] text-[#F5F0E8] px-6 py-16">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap gap-6 font-mono text-sm mb-6">
            ...
            <span className="text-gray-600">|</span>
            <span>
              <span className="text-[#F5F0E8] text-2xl font-bold">{DEPARTMENTS.length}</span>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="border border-gray-700 rounded-sm">
            <div className="border-b border-gray-700 px-4 py-2 flex items-center gap-2">
              ...
              <span className="font-mono text-xs text-gray-400 tracking-widest uppercase">North Queensland Spotlight</span>
            </div>
            <div className="px-4 py-4">
              <div className="flex flex-wrap gap-6 font-mono text-sm mb-4">
                <span>
                  <span className="text-[#059669] text-xl font-bold">{fmtCompact(NQ_SPOTLIGHT.totalFunding)}</span>
                  <span className="text-gray-400 ml-2">total funding</span>
                </span>
                <span className="text-gray-600">|</span>
                <span>
                  <span className="text-[#F5F0E8] font-bold">{fmtNum(NQ_SPOTLIGHT.records)}</span>
                  <span className="text-gray-400 ml-2">records</span>
                </span>
                <span className="text-gray-600">|</span>
                <span>
                  <span className="text-[#F5F0E8] font-bold">{fmtNum(NQ_SPOTLIGHT.orgs)}</span>
                  <span className="text-gray-400 ml-2">organisations</span>
                </span>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {NQ_SPOTLIGHT.locations.map((loc) => (
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div className="border border-gray-300 rounded-sm bg-[#F5F0E8]">
              <div className="border-b border-gray-300 px-4 py-2 flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-[#DC2626]" />
                <span className="font-mono text-xs text-gray-500 tracking-widest uppercase">QLD Budget Allocation (ROGS 2024-25)</span>
              </div>
              <div className="px-4 py-4">
                {totalSpending != null ? (
                  <>
                    ...
                    {detentionSpending != null && communitySpending != null && (
                      <p className="font-mono text-xs text-gray-400 mt-3">
                        ...
                        {totalSpending != null ? `~${Math.round(KIDS_IN_DETENTION_QLD)}` : '~40'} young people on an average night
                      </p>
                    )}
                  </>
                ) : (
                  <div className="text-sm text-gray-500">
                    <p className="font-mono mb-2">QLD Youth Justice (Productivity Commission ROGS)</p>
              ...
              <div className="px-4 py-4">
                ...
                <div className="bg-gray-100 border border-gray-200 rounded-sm p-4">
                  ...
                  <p className="font-mono text-sm text-[#0A0A0A]">
                    <span className="text-[#DC2626] font-bold">{KIDS_IN_DETENTION_QLD} kids</span> in QLD detention on an average night
                  </p>
      ...
      <section className="bg-[#0A0A0A] text-[#F5F0E8] px-6 py-16">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-gray-400 text-sm font-mono mb-8 max-w-3xl">
            ...
            and school exclusion. The data shows the pipeline — and QLD has the highest crossover rate in the country.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="border border-gray-700 rounded-sm p-6">
              ...
              <p className="text-sm text-gray-400 mb-4">
                of QLD youth justice kids had child protection contact in the prior 10 years
              </p>
              <div className="border-t border-gray-700 pt-3 space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  <span className="text-gray-500">QLD crossover count</span>
            ...
            <div className="border border-gray-700 rounded-sm p-6">
              ...
              <p className="text-sm text-gray-400 mb-4">
                First Nations young people are over-represented in QLD youth detention
              </p>
              <div className="border-t border-gray-700 pt-3 space-y-2">
                <div className="flex justify-between text-sm">
          ...
          <div className="border border-gray-700 rounded-sm p-6">
            ...
            <p className="text-center text-xs text-gray-500 mt-4 max-w-2xl mx-auto">
              72.9% of QLD youth justice kids came through child protection. The system creates its own demand.
      ...
      <section className="bg-[#0A0A0A] text-[#F5F0E8] px-6 py-16">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-gray-400 text-sm font-mono mb-8">
            Real voices from North Queensland. From real transcripts. From real people.
          </p>
      ...
      <section className="bg-[#F5F0E8] px-6 py-16">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="border border-gray-300 rounded-sm mb-8">
            <div className="border-b border-gray-300 px-4 py-2 flex items-center gap-2">
              <span className="w-2 h-2 rounded-full bg-[#059669]" />
              <span className="font-mono text-xs text-gray-500 tracking-widest uppercase">The Townsville Model</span>
            </div>
            <div className="px-6 py-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                <div>
                  <p className="text-[#0A0A0A] leading-relaxed mb-4">
                    A community-controlled hub on the centre block. Built by the community, for the community.
                    Not another government program — a genuine transfer of power and resources.
                  </p>
                  <ul className="space-y-3">
                    {[
                      { icon: 'Housing', desc: 'Safe housing for young people exiting the system' },
                      { icon: 'Employment', desc: 'Employment pathways (BG Fit model, real jobs)' },
                      { icon: 'Elders', desc: 'Elder connection (Uncle George, Kalkadoon knowledge)' },
                      { icon: 'Education', desc: 'Flexible education and training support' },
                      { icon: 'Culture', desc: 'Cultural healing and identity programs' },
                      { icon: 'Health', desc: 'Trauma-informed health and wellbeing' },
                    ].map((item) => (
                      <li key={item.icon} className="flex items-start gap-3">
                        <span className="font-mono text-xs text-[#059669] font-bold mt-0.5 w-20 shrink-0">[{item.icon}]</span>
                        <span className="text-sm text-[#0A0A0A]">{item.desc}</span>
                      </li>
                    ))}
                  </ul>
                </div>
              ...
              <div className="border-t border-gray-200 pt-6">
                ...
                <div className="flex items-center gap-3 flex-wrap">
                  {['Mount Isa', 'Townsville', 'Cairns', 'Palm Island'].map((loc, i) => (
                    <div key={loc} className="flex items-center gap-3">
                      <div className="bg-[#059669] text-[#F5F0E8] px-3 py-1.5 rounded-sm font-mono text-sm font-bold">
                        {loc}
                      </div>
                      {i < 3 && <span className="text-gray-400 font-mono">&rarr;</span>}
                    </div>
                  ))}
      ...
      <section className="bg-[#0A0A0A] text-[#F5F0E8] px-6 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-400 text-lg mb-8 max-w-2xl mx-auto">
            Queensland spends {fmtCompact(DETENTION_COST_PER_DAY)}/day per child in detention and
          ...
          <p className="font-mono text-xs text-gray-600 mt-8">
            ...
            Sources: QLD Open Data Portal, AIHW, Productivity Commission ROGS, BOCSAR, Empathy Ledger.
          </p>
        </div>
      </section>
      ...
      <footer className="bg-[#0A0A0A] border-t border-gray-800 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between font-mono text-xs text-gray-600">
          <span>JusticeHub / QLD System Map</span>
