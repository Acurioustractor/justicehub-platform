      ...
      <div className="max-w-2xl mx-auto px-4 py-8 sm:py-12">
        ...
        {step === 'role' && (
          <div>
            ...
            <p className="text-[#F5F0E8]/90 mb-8 font-mono text-sm">
                  ...
                  >
                    <div className="flex items-start gap-4">
                      <div className={`p-2 ${isSelected ? 'bg-[#DC2626]/20' : 'bg-[#F5F0E8]/5'}`}>
                        <Icon className={`w-5 h-5 ${isSelected ? 'text-[#DC2626]' : 'text-[#F5F0E8]/90'}`} />
                      </div>
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-[#F5F0E8]/90 font-mono mt-0.5">{role.tagline}</p>
                        <p className="text-sm text-[#F5F0E8]/90 mt-2">{role.description}</p>
                      </div>
                    </div>
                  </button>
                );
            ...
            <p className="text-center text-sm text-[#F5F0E8]/90 mt-6">
        ...
        {step === 'account' && (
          <div>
            <button onClick={() => setStep('role')} className="text-sm text-[#F5F0E8]/90 hover:text-[#F5F0E8] mb-6 flex items-center gap-1">
            ...
            <form onSubmit={handleAccountCreation} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  required
                />
                <p className="text-xs text-[#F5F0E8]/90 mt-1 font-mono">At least 8 characters</p>
              </div>
              <div>
        ...
        {step === 'profile' && (
          <div>
            <button onClick={() => setStep('account')} className="text-sm text-[#F5F0E8]/90 hover:text-[#F5F0E8] mb-6 flex items-center gap-1">
              <ArrowLeft className="w-3 h-3" /> Back
            </button>
            ...
            <form onSubmit={handleProfileCreation} className="space-y-5">
              ...
              {memberRole === 'organization' && (
                <div>
                  ...
                  <div className="relative">
                    <Search className="absolute left-3 top-3.5 w-4 h-4 text-[#F5F0E8]/95" />
                    <input
                      type="text"
                      value={orgQuery}
                      onChange={(e) => {
                    ...
                    />
                    {orgSearching && <Loader2 className="absolute right-3 top-3.5 w-4 h-4 animate-spin text-[#F5F0E8]/95" />}
                  </div>
                  ...
                  {selectedOrg && (
                    <div className="mt-2 p-3 border border-[#059669] bg-[#059669]/10 flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-[#F5F0E8]/90 font-mono">
                      ...
                      {orgResults.map((org) => (
                        ...
                        >
                          <p className="font-bold text-sm text-[#F5F0E8]">
                            {org.name}
                            {org.source === 'grantscope' && <span className="ml-2 text-[12px] font-mono text-blue-400 bg-blue-400/10 px-1.5 py-0.5">ABR</span>}
                          </p>
                          <p className="text-xs text-[#F5F0E8]/95 font-mono">
                  ...
                  {orgQuery.length >= 2 && !orgSearching && orgResults.length === 0 && !selectedOrg && (
                    <p className="text-xs text-[#F5F0E8]/90 mt-2 font-mono">
              ...
              <label className="flex items-start gap-3 cursor-pointer pt-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#F5F0E8]/90 mt-1 font-mono">
        ...
        {step === 'complete' && (
          <div className="text-center py-8">
            ...
            <p className="text-[#F5F0E8]/90 font-mono text-sm mb-8 max-w-md mx-auto">
            ...
            {selectedOrg && (
              <div className="mb-8 p-4 border border-[#F5F0E8]/10 bg-[#F5F0E8]/[0.02] text-left max-w-md mx-auto">
                <p className="font-mono text-xs text-[#F5F0E8]/90 mb-1">ORGANISATION CLAIMED</p>
                <p className="font-bold">{selectedOrg.name}</p>
                <p className="text-xs text-[#F5F0E8]/90 font-mono mt-1">
            ...
            <div className="space-y-3 max-w-md mx-auto">
              ...
              <button
                ...
                className="w-full px-6 py-3 border border-[#F5F0E8]/20 text-[#F5F0E8]/90 hover:text-[#F5F0E8] hover:border-[#F5F0E8]/40 transition-colors font-mono text-sm"
              >
                Back to CONTAINED
              </button>
            </div>
  ...
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-[#0A0A0A] flex items-center justify-center">
        <Loader2 className="w-8 h-8 animate-spin text-[#F5F0E8]/95" />
      </div>
    }>
      <JoinContent />
    </Suspense>
