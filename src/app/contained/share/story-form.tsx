                  ...
                  <div className="flex flex-wrap gap-3 justify-center">
                    <a
                      href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(
                        `I just shared my experience with CONTAINED — an immersive tour showing what youth detention is really like. Share yours: ${SITE_URL}/contained/share #TheContained #YouthJustice`
                      )}`}
                      target="_blank"
