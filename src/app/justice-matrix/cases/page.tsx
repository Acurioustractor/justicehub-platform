            ...
            <div>
              <div className="flex items-baseline justify-between gap-3 mb-6">
                ...
                <div className="text-xs whitespace-nowrap" style={{ color: '#5e5145' }}>
                  Export this set:{' '}
                  <a href={`/api/justice-matrix/export${urlWith(current, { type: 'case', format: 'csv' })}`} className="underline font-semibold" style={{ color: '#8d6a44' }}>
                    CSV
                  </a>
                  {' · '}
                  <a href={`/api/justice-matrix/export${urlWith(current, { type: 'case', format: 'json' })}`} className="underline font-semibold" style={{ color: '#8d6a44' }}>
                    JSON
                  </a>
                </div>
              </div>
