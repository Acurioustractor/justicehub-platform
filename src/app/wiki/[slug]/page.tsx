...
const SLUG_TO_FILE: Record<string, string> = {
  ...
  'minderoo-one-pager': 'strategic/MINDAROO_ONE_PAGER.md',
  'minderoo-strategic-pitch': 'strategic/MINDAROO_CORE_PITCH.md',
  'minderoo-budget-breakdown': 'budget/THREE_SCENARIOS_COMPLETE_3_YEAR.md',
  'minderoo-research-paper': 'strategic/STRATEGIC_OVERVIEW.md',
