  ...
  try {
    ...
    return NextResponse.json({
      totals: {
        ...
        funding: fundingResult.count || 0,
        researchFindings: researchFindingsResult.count || 0,
        mediaArticles: mediaArticlesResult.count || 0,
        matrixCases: matrixCasesResult.count || 0,
        acncCharities: acncResult.count || 0,
        oricCorporations: oricResult.count || 0,
        rogsSpending: rogsResult.count || 0,
      },
      byState: stateCounts,
