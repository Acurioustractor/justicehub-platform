            ...
            <>
              ...
              <div className="space-y-3 mb-6">
                ...
                <button
                  ...
                  disabled={!!oauthLoading}
                  className="w-full flex items-center justify-center gap-3 px-6 py-3.5 bg-[#1877F2] text-white border-2 border-[#1877F2] font-bold hover:bg-[#166FE5] transition-colors disabled:opacity-50"
                >
                ...
                <button
                  ...
                  disabled={!!oauthLoading}
                  className="w-full flex items-center justify-center gap-3 px-6 py-3.5 bg-[#0A66C2] text-white border-2 border-[#0A66C2] font-bold hover:bg-[#004182] transition-colors disabled:opacity-50"
                >
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="white">
